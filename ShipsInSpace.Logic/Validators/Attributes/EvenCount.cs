...
namespace ShipsInSpace.Logic.Validators.Attributes
{
    public class EvenCount : ValidationAttribute
    {
        ...
        {
            if (value is int intValue && intValue % 2 == 0) return ValidationResult.Success;

            if (value is IEnumerable<object> listValue && listValue.Count() % 2 == 0) return ValidationResult.Success;
